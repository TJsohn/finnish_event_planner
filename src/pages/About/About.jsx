  ...
  return (
    <main className={styles.mainContainer}>
      <div className={styles.contentContainer}>
        <h1 className={styles.abouth1}>About Freydis</h1>
        ...
        <div className={styles.contactCardContainer}>
          <div className={styles.contactCard}>
            ...
            <img
              ...
              alt="Anton"
            />
            <p className={styles.content}>📧:anton@gmail.com</p>
            <p className={styles.content}>☎️:040004000</p>
          </div>
          ...
          <div className={styles.contactCard}>
            ...
            <img
              ...
              alt="TJ"
            />
            <p className={styles.content}>📧:taejeon@gmail.com</p>
            <p className={styles.content}>☎️:0400041110</p>
          </div>
          ...
          <div className={styles.contactCard}>
            ...
            <img
              ...
              alt="Anton"
            />
            <p className={styles.content}>📧:jamilnim@gmail.com</p>
            <p className={styles.content}>☎️:0400041110</p>
          </div>
        </div>
      </div>
